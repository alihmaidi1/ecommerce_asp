...
//        public Task<AddCategoryResponse> Update(CategoryId Id,string Name, string Description, string Meta_Title, int rank, string Meta_Description, Guid? ParentId, List<string> Images, List<string> deletedImages);
