        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetaLogoUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MetaLogoHash = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MetaLogoResized = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    categoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Price = table.Column<float>(type: "real", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    MinQuantity = table.Column<int>(type: "int", nullable: false),
<<<<<<<< HEAD:src/Infrutructure/Migrations/20230925124505_init.cs
...
>>>>>>>> 07266b15958bf96eea3c784909c9f5bee4e25ecf:src/Infrutructure/Migrations/20230922172107_init.cs
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateDeleted = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DateUpdated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_Copons_couponId",
                        column: x => x.couponId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderType = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    ...
                    resizedLogo = table.Column<string>(type: "nvarchar(max)", nullable: true),
